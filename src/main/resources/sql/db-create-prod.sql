...
/******************************************/
DROP database if exists internet_market_prod;
CREATE DATABASE if not exists internet_market_prod CHARACTER SET UTF8 COLLATE utf8_unicode_ci;

use internet_market_prod;
